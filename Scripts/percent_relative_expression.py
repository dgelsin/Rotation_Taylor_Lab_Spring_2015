...
for hum_relative_RPKM in ["Human_Muscle_Relative_Gene_Expression_Difference(RPKM)"]:
	...
	data_table[col_name] = data_table.apply(lambda r: ((r["Human_Muscle_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for human
for hum_relative_RPKM in ["Chimp_Muscle_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Chimp_Muscle_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
...
for hum_relative_RPKM in ["Rhesus_Monkey_Muscle_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Rhesus_Monkey_Muscle_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for rhesus monkey
data_table[["Human_Muscle_Relative_Gene_Expression_Difference(RPKM)", "Chimp_Muscle_Relative_Gene_Expression_Difference(RPKM)", "Rhesus_Monkey_Muscle_Relative_Gene_Expression_Difference(RPKM)"]].to_csv("/Users/cmdb/Desktop/Rotation_4_-_Taylor_Lab/Data/Programs/muscle_percent_relative_expression_with_gene_names_RPKM.tsv", sep="\t", header=True)
...
for hum_relative_RPKM in ["Human_Kidney_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Human_Kidney_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for human
for hum_relative_RPKM in ["Chimp_Kidney_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Chimp_Kidney_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for chimp
for hum_relative_RPKM in ["Rhesus_Monkey_Kidney_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Rhesus_Monkey_Kidney_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for rhesus monkey
data_table[["Human_Kidney_Relative_Gene_Expression_Difference(RPKM)", "Chimp_Kidney_Relative_Gene_Expression_Difference(RPKM)", "Rhesus_Monkey_Kidney_Relative_Gene_Expression_Difference(RPKM)"]].to_csv("/Users/cmdb/Desktop/Rotation_4_-_Taylor_Lab/Data/Programs/kidney_percent_relative_expression_with_gene_names_RPKM.tsv", sep="\t", header=True)
...
for hum_relative_RPKM in ["Chimp_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Chimp_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for chimp
for hum_relative_RPKM in ["Rhesus_Monkey_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Rhesus_Monkey_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for rhesus monkey
data_table[["Human_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)", "Chimp_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)", "Rhesus_Monkey_Cerebellar_Cortex_Relative_Gene_Expression_Difference(RPKM)"]].to_csv("/Users/cmdb/Desktop/Rotation_4_-_Taylor_Lab/Data/Programs/cerebellar_cortex_percent_relative_expression_with_gene_names_RPKM.tsv", sep="\t", header=True)
...
for hum_relative_RPKM in ["Human_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Human_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for human
for hum_relative_RPKM in ["Chimp_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Chimp_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for chimp
for hum_relative_RPKM in ["Rhesus_Monkey_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]:
	col_name = hum_relative_RPKM
	data_table[col_name] = data_table.apply(lambda r: ((r["Rhesus_Monkey_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]*100)), axis=1)
#calculate relative expression for rhesus monkey
data_table[["Human_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)", "Chimp_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)", "Rhesus_Monkey_Prefrontal_Cortex_Relative_Gene_Expression_Difference(RPKM)"]].to_csv("/Users/cmdb/Desktop/Rotation_4_-_Taylor_Lab/Data/Programs/prefrontal_cortex_percent_relative_expression_with_gene_names_RPKM.tsv", sep="\t", header=True)
