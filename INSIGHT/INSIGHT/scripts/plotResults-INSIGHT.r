# Hmisc IS A REQUIRED LIBRARY. POINT TO NECESSARY LIBRARY USING 'lib.loc=???', IF NECESSARY.
library("Hmisc");
...
pValCutoffs=c(0.01,0.01,0.01);     # CUTOFFS FOR P-VALUE
...
barPositions = 
   ...
   errbar ( add=TRUE , x=barPositions , y=height , yplus=pmin(height+stds,1.0) ,
